...
const Main = () => {
    return (
        <main className="md:ml-64 pt-20 px-container-padding-mobile md:px-container-padding-desktop pb-24 max-w-[1600px] mx-auto">
            {/* <!-- Header --> */}
            <div className="mb-section-margin mt-8 flex flex-col md:flex-row md:items-end justify-between gap-4">
                ...
                <div className="flex gap-3">
                    ...
                    <button className="px-4 py-2 bg-gradient-to-b from-[#14B8A6] to-[#0F766E] text-white material-symbols-outlined  text-label-lg rounded-lg hover:opacity-90 transition-opacity shadow-sm flex items-center gap-2">
